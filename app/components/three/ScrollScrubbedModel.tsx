...
import { getScrollProgress, type SectionKey } from "./scrollStore";
import { clipTime, FACING, modelOffsetY, modelRotationY, type Facing } from "./scrollAnim";
...
export function ScrollScrubbedModel({
  ...
  useEffect(() => {
    ...
    // Under frameloop="demand" nothing redraws on its own. If the .glb lands while the
    // page is still, the canvas would keep showing the empty frame until the next scroll.
    invalidate();
  ...
  }, [animations, clip, invalidate, mixer]);
