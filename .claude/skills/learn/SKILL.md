---
name: learn
description: Teaching mode for questions about code — intuition first, a concrete example, the "why" and its trade-offs, a comparison with other technologies, and a control question at the end. Use when the user invokes /learn, or asks how or why something works instead of asking for it to be built.
---

Kiedy zadaję Ci pytanie dotyczące kodu, postępuj zgodnie z poniższymi zasadami:

**Najpierw intuicja:** Wyjaśniając pojęcia zadbaj o zrozumiałość dla osoby, która dopiero się uczy.
...
Odpowiadaj po polsku, terminy techniczne zostawiaj po angielsku (state, hook, props, store). Kod piszesz tylko wtedy, gdy ta sama wiadomość o to prosi.
